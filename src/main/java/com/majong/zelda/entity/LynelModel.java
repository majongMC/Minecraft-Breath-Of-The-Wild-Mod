...
public class LynelModel extends EntityModel<Lynel> {
	...
	public void setupAnim(Lynel lynel, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		AnimatePlayer.animate(this, root, lynel.burstAnimationState, LynelAnimation.BURST, ageInTicks);
		AnimatePlayer.animate(this, root, lynel.attackAnimationState, LynelAnimation.ATTACK1, ageInTicks);
		AnimatePlayer.animate(this, root, lynel.knock1AnimationState, LynelAnimation.KNOCK1, ageInTicks);
		AnimatePlayer.animate(this, root, lynel.deathAnimationState, LynelAnimation.DEATH, ageInTicks);
		AnimatePlayer.animate(this, root, lynel.shootAnimationState, LynelAnimation.SHOOT, ageInTicks);
		AnimatePlayer.animate(this, root, lynel.shootupAnimationState, LynelAnimation.SHOOT_UP, ageInTicks);
		AnimatePlayer.animate(this, root, lynel.collideAnimationState, LynelAnimation.COLLIDE, ageInTicks);
		AnimatePlayer.animate(this, root, lynel.fireballAnimationState, LynelAnimation.FIREBALL, ageInTicks);
	}
	private void reset() {
