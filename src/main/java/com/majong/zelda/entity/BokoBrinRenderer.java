...
public class BokoBrinRenderer extends HumanoidMobRenderer<BokoBrinEntity,BokoBrinModel>{
	...
	public BokoBrinRenderer(EntityRendererProvider.Context renderManagerIn, BokoBrinModel entityModelIn, float shadowSizeIn) {
		super(renderManagerIn, entityModelIn, shadowSizeIn);
		this.addLayer(new HumanoidArmorLayer<>(this, new HumanoidModel<BokoBrinEntity>(renderManagerIn.bakeLayer(INNER_ARMOR)), new HumanoidModel<BokoBrinEntity>(renderManagerIn.bakeLayer(OUTER_ARMOR))));
		// TODO �Զ����ɵĹ��캯�����
	}
