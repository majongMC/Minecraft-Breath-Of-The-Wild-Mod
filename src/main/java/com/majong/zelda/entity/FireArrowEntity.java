	...
	private void placefire() {
		for(int i=-1;i<2;i++)
			 for(int j=-1;j<2;j++)
			 {
				 ...
				 {
					 if(this.level.getBlockState(new BlockPos((int)(this.getX()+i),y,(int)(this.getZ()+j))).getBlock()==Blocks.AIR||this.level.getBlockState(new BlockPos((int)(this.getX()+i),y,(int)(this.getZ()+j))).getBlock()==Blocks.FIRE)
					 {
						 this.level.setBlockAndUpdate(new BlockPos((int)(this.getX()+i),y,(int)(this.getZ()+j)),Blocks.FIRE.defaultBlockState());
						 break;
					 }
				 }
			 }
