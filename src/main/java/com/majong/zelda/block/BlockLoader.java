...
public class BlockLoader {
	...
	public static final RegistryObject<Item> ITEM_TEMPLE_START = ItemLoader.ITEMS.register("temple_start",() -> new BlockItem(TEMPLE_START.get(), new Item.Properties().tab(Utils.ZELDA_CREATIVE_TAB)));
	...
	public static final RegistryObject<Item> ITEM_STATIC_TEMPLE_START = ItemLoader.ITEMS.register("static_temple_start",() -> new BlockItem(STATIC_TEMPLE_START.get(), new Item.Properties().tab(Utils.ZELDA_CREATIVE_TAB)));
