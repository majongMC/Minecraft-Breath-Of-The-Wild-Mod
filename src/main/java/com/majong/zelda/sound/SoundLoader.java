...
public class SoundLoader {
	...
	public static final RegistryObject<SoundEvent> ROCK_GIANT_DESTROY = SOUNDS.register("rock_giant_destroy", () -> new SoundEvent(new ResourceLocation(Utils.MOD_ID, "rock_giant_destroy")));
