...
public class BeastGodBow  extends ProjectileWeaponItem implements Vanishable {
	public static final int MAX_DRAW_DURATION = 20;
	   public static final int DEFAULT_RANGE = 15;

	   public BeastGodBow() {
	      super(new Properties().tab(Utils.ZELDA_CREATIVE_TAB).durability(384));
	   }
	         ...
	         if (!itemstack.isEmpty() || flag) {
	            ...
	            if (!((double)f < 0.1D)) {
	               ...
	               if (!p_40668_.isClientSide) {
	                  ...
	                  abstractarrow1.shootFromRotation(player, player.getXRot()-2, player.getYRot(), 0.0F, f * 3.0F, 1.0F);
	                  AbstractArrow abstractarrow2 = arrowitem.createArrow(p_40668_, itemstack, player);
	                  abstractarrow2.shootFromRotation(player, player.getXRot()+2, player.getYRot(), 0.0F, f * 3.0F, 1.0F);
	                  AbstractArrow abstractarrow3 = arrowitem.createArrow(p_40668_, itemstack, player);
	                  abstractarrow3.shootFromRotation(player, player.getXRot(), player.getYRot()-2, 0.0F, f * 3.0F, 1.0F);
	                  AbstractArrow abstractarrow4 = arrowitem.createArrow(p_40668_, itemstack, player);
	                  abstractarrow4.shootFromRotation(player, player.getXRot(), player.getYRot()+2, 0.0F, f * 3.0F, 1.0F);
	                  if (f == 1.0F) {
	                  ...
	                  if (j > 0) {
	                     ...
	                     abstractarrow1.setBaseDamage(abstractarrow.getBaseDamage() + (double)j * 0.5D + 0.5D);
	                     ...
	                     abstractarrow4.setBaseDamage(abstractarrow.getBaseDamage() + (double)j * 0.5D + 0.5D);
	                  }
	                  ...
	                  if (EnchantmentHelper.getItemEnchantmentLevel(Enchantments.FLAMING_ARROWS, p_40667_) > 0) {
	                     ...
	                     abstractarrow4.setSecondsOnFire(100);
	                  }
	                  ...
	                  abstractarrow4.pickup = AbstractArrow.Pickup.CREATIVE_ONLY;
	                  ...
	                  p_40668_.addFreshEntity(abstractarrow4);
	               }
