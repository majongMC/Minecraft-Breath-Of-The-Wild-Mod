...
public class ZeldaOverlays extends AbstractGui{
	...
	public void render(ClientPlayerEntity player) {
		...
		if(DataManager.data.get(player).unlocked[0])
			drawCenteredString(matrixStack,Minecraft.getInstance().font,"x"+DataManager.data.get(player).skill[0],(int)(0.05*w)+24,(int)(0.2*h)+12,16777215);
		if(DataManager.data.get(player).unlocked[1])
			drawCenteredString(matrixStack,Minecraft.getInstance().font,"x"+DataManager.data.get(player).skill[1],(int)(0.05*w)+24,(int)(0.3*h)+12,16777215);
		if(DataManager.data.get(player).unlocked[2])
			drawCenteredString(matrixStack,Minecraft.getInstance().font,"x"+DataManager.data.get(player).skill[2],(int)(0.05*w)+24,(int)(0.4*h)+12,16777215);
		if(DataManager.data.get(player).unlocked[3])
			drawCenteredString(matrixStack,Minecraft.getInstance().font,"x"+DataManager.data.get(player).skill[3],(int)(0.05*w)+24,(int)(0.5*h)+12,16777215);
	}
}
